...
\end{equation}
where $\ell(S, T)$ is the cross-entropy of the temperature-scaled scores from \eqref{eq:maxsim} against the diagonal positive assignment.
